...
export const QUESTION_RE =
  /[?？]\s*$|(有没有|有木有|谁知道|谁有|请问|想问下|想问|想问问|问一下|问下|问个|请教|求教|求问|求解答|求推荐|求指点|求个|有人用|大家推荐|有推荐|推荐个|推荐下|推荐一个|给推荐|值得|靠谱吗|怎么样|怎么选|如何选|咋样|好不好|了解过|用过的|用过吗|听说过吗|哪个好|哪家好|怎么用|如何用|需要吗|有.{0,6}吗|想咨询|想了解|咨询一下|咨询下|想咨询下|想问问)/
